...
try {
 ...
 const tests=process.argv.includes('--browser') ? ['tests/acceptance.test.mjs','tests/articles.test.mjs','tests/payment-return.test.mjs'] : ['tests/http.test.mjs','tests/users-model.test.mjs','tests/navigation.test.mjs'];
