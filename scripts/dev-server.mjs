...
const credentials=fs.existsSync(file)?JSON.parse(fs.readFileSync(file,'utf8')):{email:'10000001@qq.com',password:crypto.randomBytes(24).toString('hex').replace(/.{5}/g,'$&-')};
